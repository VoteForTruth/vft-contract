...
describe('Vft', () => {
    ...
    it('should deploy arguments', async () => {
        ...
        const proArgumentData = {
            $$type: 'VftData' as const,
            statement: 'true argument',
            url: null
        }
        ...
        const conArgumentData = {
            $$type: 'VftData' as const,
            statement: 'false argument',
            url: null
        }
    ...
    it('should deploy vote', async () => {
        ...
        let deployResult = await vftStatement.send(voteOwner.getSender(), { value: voteDeployTons }, 'vote')
